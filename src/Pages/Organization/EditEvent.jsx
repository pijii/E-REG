        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-12  back-button">
                    <button className='bg-transparent border-0 mx-0' onClick={goToEventView}><h5 className='fw-bold'>⟵Back to Event</h5></button>
                </div>
            </div>
            <div className="row shadow-lg form-box">
                <form action="">
                    ...
                    <div className="row mt-5 d-flex p-lg-5 pb-5">
                        ...
                        <div className="col-12 mt-4 text-center">
                            <input type="submit" value="Update Event" className="submit-button mt-3 btn-transform" />
                        </div>
                    </div>
                </form>
            </div>
